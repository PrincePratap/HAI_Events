...
internal interface AuthRepository {
    ...
    suspend fun forgetPasswordReSendPassword(request: ReSendOTPRequest): Result<ForgetPasswordReSendOTPResponse>
    suspend fun reSendPassword(request: ReSendOTPRequest): Result<ReSendOTPResponse>
